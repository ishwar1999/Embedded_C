...
void TimerGenMode(void);{
    ...
    SET_TIMERPWM; //setting timer1 for PWM
    PRESCALE_TIMER; //8 prescalar
    SET_AS_OUTPUT; //Setting PB1 as output pin

}

/**
 * @brief A function which receive 10 bit of ADC input from temperature sensor and outputs as a fast PWM waveform.
 * 
 * @param ADC_val 
 * @return char
 */
